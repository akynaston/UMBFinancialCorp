...
public class ExcelParserTests extends TestCase {
    ...
    public void testParser() throws Exception {
        System.setProperty("ConfigLocation", "doc/IdMUnit-Reference-idmunit-config.xml");
        System.setProperty("ApplySubstitutionsToOperations", "false");
        System.setProperty("ApplySubstitutionsToData", "true");
        TestSuite workbookSuite = (TestSuite)ExcelParser.parseSheets("doc/IdMUnitReference.xls", "testReference");
        TestSuite suite = ((ConnectorManager)workbookSuite.testAt(0)).getSuite();

        assertEquals(24, suite.testCount());
        Enumeration<IdMUnitTestCase> steps = suite.tests();

        IdMUnitTestCase row8 = steps.nextElement();
        ...
        IdMUnitTestCase row9 = steps.nextElement();
        ...
        IdMUnitTestCase row10 = steps.nextElement();
        ...
        IdMUnitTestCase row28 = steps.nextElement();
    ...
    public void testMultipleHeaderRows() throws Exception {
        ...
        System.setProperty("ApplySubstitutionsToOperations", "false");
        System.setProperty("ApplySubstitutionsToData", "true");
        TestSuite workbookSuite = (TestSuite)ExcelParser.parseSheets("doc/IdMUnitReference.xls", "testHeaders");
        TestSuite suite = ((ConnectorManager)workbookSuite.testAt(0)).getSuite();
    ...
    @SuppressWarnings("unchecked")
    public void testParseAllSheets() throws Exception {
        System.setProperty("ConfigLocation", "doc/IdMUnit-Reference-idmunit-config.xml");
        System.setProperty("ApplySubstitutionsToOperations", "false");
        System.setProperty("ApplySubstitutionsToData", "true");
        TestSuite workbookSuite = (TestSuite)ExcelParser.parseAllSheets("doc/IdMUnitReference.xls");

        assertEquals(3, workbookSuite.testCount());
        Enumeration<ConnectorManager> tests = workbookSuite.tests();

        ConnectorManager sheet1 = tests.nextElement();
        assertEquals("testReference", sheet1.getSuite().getName());

        ConnectorManager sheet2 = tests.nextElement();
        assertEquals("testCleanup", sheet2.getSuite().getName());

        ConnectorManager sheet3 = tests.nextElement();
        assertEquals("testHeaders", sheet3.getSuite().getName());
    }

    @SuppressWarnings("unchecked")
    public void testParseSheets() throws Exception {
        System.setProperty("ConfigLocation", "doc/IdMUnit-Reference-idmunit-config.xml");
        System.setProperty("ApplySubstitutionsToOperations", "false");
        System.setProperty("ApplySubstitutionsToData", "true");
        TestSuite workbookSuite = (TestSuite)ExcelParser.parseSheets("doc/IdMUnitReference.xls", "testCleanup", "testReference", "testCleanup");

        assertEquals(3, workbookSuite.testCount());
        Enumeration<ConnectorManager> tests = workbookSuite.tests();

        ConnectorManager sheet1 = tests.nextElement();
        assertEquals("testCleanup", sheet1.getSuite().getName());

        ConnectorManager sheet2 = tests.nextElement();
        assertEquals("testReference", sheet2.getSuite().getName());

        ConnectorManager sheet3 = tests.nextElement();
        assertEquals("testCleanup", sheet3.getSuite().getName());
    }
}
